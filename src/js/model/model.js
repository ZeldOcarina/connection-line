export const heroLink = $('.navigation__link--home');
export const countersLink = $('.navigation__link--counters');
export const storyLink = $('.navigation__link--story');
export const settoriLink = $('.navigation__link--settori');
export const testimonialsLink = $('.navigation__link--testimonials');
